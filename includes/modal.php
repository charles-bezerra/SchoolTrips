			...
			<div class='modal-dialog' role='document'>
				<div class='modal-content'>
					  <div class='modal-header'>
					    <h5 class='modal-title'><i class='fa fa-plus' aria-hidden='true'></i> Agende sua viagem aqui</h5>
					  ...
					  <form>
					   	  <div class='modal-body'>
								  <div class="form-group">
								    <label><i class="fa fa-calendar-o" aria-hidden="true"></i> Data de ida</label>
								    <input type="date" 
								    <?php 
								    	$data = date('Y-m-d');
								    	echo "min='$data'";
								  ...
								  <div class="form-group">
								    <label><i class="fa fa-bus" aria-hidden="true"></i> Selecione o ônibus</label>
